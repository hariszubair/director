                     ...
                     <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                       ...
                                       <div class="form-group col-md-6 col-sm-6 col-xs-12" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <input  class="form-control minus_number_only" name="financial[underlying_profit]" id="financial[underlying_profit]" value="{{old('financial[underlying_profit]')}}" tabindex="13" >
                                            </div>
                                        </div>
                                      </div>
                                      <div class="form-group col-md-6 col-sm-6 col-xs-12" >
                                      ...
                                      <div class="form-group col-md-6 col-sm-6 col-xs-12" >
                                       ...
                                       <div class="form-group col-md-6 col-sm-6 col-xs-12" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <input  class="form-control minus_number_only" name="financial[basic_eps]" id="financial[basic_eps]" value="{{old('financial[basic_eps]')}}" tabindex="17" required   step=".01">
                                            </div>
                                        </div>
                                      </div>
                                      <div class="form-group col-md-6 col-sm-6 col-xs-12" >
